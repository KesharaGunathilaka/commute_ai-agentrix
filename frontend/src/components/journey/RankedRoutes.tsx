...
import { Bus, Check, ChevronDown, ListOrdered, Train } from "lucide-react";
...
export function RankedRoutes({
  ...
  const [open, setOpen] = useState(agentOptimisedFor === "cheapest");
  ...
  return (
    <Panel className={cn("overflow-hidden", className)}>
      ...
      >
        <PanelHeader icon={<ListOrdered className="size-3.5" />} title="Other options" />
                  ...
                  <li key={route.route_id ?? index}>
                    ...
                    >
                      ...
                      <div className="shrink-0 text-right">
                        ...
                        {fare && (
                          <p className="tabular text-[11px] text-glow-400">{fare}</p>
                        )}
                      </div>
                    </button>
                  </li>
